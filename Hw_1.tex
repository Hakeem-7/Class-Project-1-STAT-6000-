...
\includegraphics{Hw_1_files/figure-latex/unnamed-chunk-1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{## (iii)}
\KeywordTok{jpeg}\NormalTok{(}\StringTok{"Q1C.jpeg"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(College}\OperatorTok{$}\NormalTok{Private,College}\OperatorTok{$}\NormalTok{Outstate, }\DataTypeTok{col =} \StringTok{"violet"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Private"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Outstate"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Plot of Outstate vs Private"}\NormalTok{)}
...
\NormalTok{Elite [College}\OperatorTok{$}\NormalTok{Top10perc }\OperatorTok{>}\DecValTok{50}\NormalTok{]=}\StringTok{"Yes"}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pdf}\NormalTok{(}\StringTok{"Outstate vs Elite.pdf"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(Elite, College}\OperatorTok{$}\NormalTok{Outstate, }\DataTypeTok{col =} \DecValTok{2}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"Elite"}\NormalTok{, }\DataTypeTok{ylab =} \StringTok{"Outstate"}\NormalTok{, }\DataTypeTok{main =} \StringTok{"Outstate vs Elite"}\NormalTok{)}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{## (v)}
\KeywordTok{jpeg}\NormalTok{(}\StringTok{"2X2 Histogram Plot.jpeg"}\NormalTok{)}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Apps, }\DataTypeTok{col =} \DecValTok{2}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Accept, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Enroll, }\DataTypeTok{col =} \StringTok{"green"}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Personal, }\DataTypeTok{col =} \StringTok{"yellow"}\NormalTok{)}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(College}\OperatorTok{$}\NormalTok{Private)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{### Plotting more than one variable in a histogram}
\KeywordTok{jpeg}\NormalTok{(}\StringTok{"exploration.jpeg"}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Apps, }\DataTypeTok{col =} \StringTok{"yellow"}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(College}\OperatorTok{$}\NormalTok{Accept, }\DataTypeTok{add =}\NormalTok{ T, }\DataTypeTok{col =} \StringTok{"blue"}\NormalTok{)}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Hw_1_files/figure-latex/unnamed-chunk-1-2.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(Auto}\OperatorTok{$}\NormalTok{cylinders,Auto}\OperatorTok{$}\NormalTok{mpg)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Hw_1_files/figure-latex/unnamed-chunk-1-3.pdf}
...
\includegraphics{Hw_1_files/figure-latex/unnamed-chunk-1-4.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{indus,Boston}\OperatorTok{$}\NormalTok{nox)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#As an example, the pairwise comparison of Industry and Nitro Oxide (predictors) suggests that a strong relationship exist between them.}

\CommentTok{## (c)}
\KeywordTok{cor}\NormalTok{(Boston[}\OperatorTok{-}\DecValTok{1}\NormalTok{], Boston}\OperatorTok{$}\NormalTok{crim)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#histogram of tax, crime, and pupil-teacher ratio}
\KeywordTok{jpeg}\NormalTok{(}\StringTok{"TCP.jpeg"}\NormalTok{)}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow =} \KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{hist}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{crim, }\DataTypeTok{xlab =} \StringTok{"Crime rate"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Number of Suburbs"}\NormalTok{, }\DataTypeTok{col =} \DecValTok{2}\NormalTok{)}
\KeywordTok{summary}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{crim)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#based on the crime rate summary and histogram, the average crime rate in the entire suburbs is roughly 4% but some suburbs have alarmingly high crime rate of about 89%.}

\NormalTok{Low_Crime_rate =}\StringTok{ }\KeywordTok{subset}\NormalTok{(Boston, Boston}\OperatorTok{$}\NormalTok{crim }\OperatorTok{>}\StringTok{ }\DecValTok{5}\NormalTok{)}
\KeywordTok{nrow}\NormalTok{(Low_Crime_rate)}\OperatorTok{/}\KeywordTok{nrow}\NormalTok{(Boston)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Over 20% of the suburbs are faced with crime rate that is beyond 5%.}
\NormalTok{High_Crime_rate =}\StringTok{ }\KeywordTok{subset}\NormalTok{(Boston, Boston}\OperatorTok{$}\NormalTok{crim }\OperatorTok{>}\StringTok{ }\DecValTok{60}\NormalTok{)}
\KeywordTok{nrow}\NormalTok{(High_Crime_rate)}\OperatorTok{/}\KeywordTok{nrow}\NormalTok{(Boston)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Approximatly 0.5% of the suburb have a high crime rate.}

\KeywordTok{hist}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{tax, }\DataTypeTok{xlab =} \StringTok{"Full-value property-tax rate /$10,000"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Number of Suburbs"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"green"}\NormalTok{)}
\NormalTok{Tax=}\StringTok{ }\KeywordTok{subset}\NormalTok{(Boston, Boston}\OperatorTok{$}\NormalTok{tax}\OperatorTok{<}\StringTok{ }\DecValTok{500}\NormalTok{)}
\KeywordTok{nrow}\NormalTok{(Tax)}\OperatorTok{/}\StringTok{ }\KeywordTok{nrow}\NormalTok{(Boston)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#72% of the houses in the Boston suburbs pay less than $500 for property tax}

\KeywordTok{hist}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{ptratio, }\DataTypeTok{xlab =}\StringTok{"Pupil-teacher ratio by town"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Number of Suburbs"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"Blue"}\NormalTok{)}
\KeywordTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{## (e)}
\KeywordTok{sum}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{chas }\OperatorTok{!=}\StringTok{ }\DecValTok{0}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# 35 Suburbs}

\CommentTok{## (f)}
\KeywordTok{median}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{ptratio)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# The median is 19}

\CommentTok{## (g)}
\NormalTok{Lowest_Median =}\StringTok{ }\NormalTok{Boston[}\KeywordTok{order}\NormalTok{(Boston}\OperatorTok{$}\NormalTok{medv),]}
\NormalTok{Lowest_Median[}\DecValTok{1}\NormalTok{,]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Suburb 399 with a median value of $5000}
\KeywordTok{summary}\NormalTok{(Boston)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# The lowest median value of owner occupied homes in Boston has a fairly high crime rate, no river for serenity, high concentration of dangerous nitrogen oxide, and low property tax.}

\CommentTok{## (h)}
\NormalTok{Rooms_}\DecValTok{7}\NormalTok{ =}\StringTok{ }\KeywordTok{subset}\NormalTok{(Boston, Boston}\OperatorTok{$}\NormalTok{rm }\OperatorTok{>}\StringTok{ }\DecValTok{7}\NormalTok{)}
\KeywordTok{nrow}\NormalTok{(Rooms_}\DecValTok{7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Only 64 suburbs have more than 7 rooms per dwelling}

\NormalTok{Rooms_}\DecValTok{8}\NormalTok{ =}\StringTok{ }\KeywordTok{subset}\NormalTok{(Boston, Boston}\OperatorTok{$}\NormalTok{rm }\OperatorTok{>}\StringTok{ }\DecValTok{8}\NormalTok{)}
\KeywordTok{nrow}\NormalTok{(Rooms_}\DecValTok{8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Just 13 suburbs average more than 8 rooms per dwelling}
\end{Highlighting}
\end{Shaded}
